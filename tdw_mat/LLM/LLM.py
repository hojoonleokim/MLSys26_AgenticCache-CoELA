            ...
            def openai_generate(prompt, sampling_params):
                ...
                try:
                    if 'gpt-5' in self.lm_id or 'gpt-4.1' in self.lm_id:
                        ...
                        with open(os.path.join(llm_dir, f"token_usage_agent_{self.agent_id}_{self.lm_id}.txt"), 'a') as f:
                            f.write(f"LM: {lm_id}\n")
                        ...
                        with open(os.path.join(llm_dir, f"chat_io_agent_{self.agent_id}_{self.lm_id}.jsonl"), 'a') as f:
