class ActionCache:
    ...
    # Action weights based on plan type selection ratios
    ACTION_WEIGHTS = {
        'putin': 0.928,
        'gograsp_target': 0.532,
        'explore': 0.245,
        'gograsp_container': 0.222,
        'transport': 0.221,
        'sendmessage': 0.198,
        'goto': 0.171
    }
    ...
    def access(self, current_step, current_room, rooms_explored, holding_objects, satisfied, object_list, obj_per_room, action_history, dialogue_history, opponent_grabbed_objects = None, opponent_last_room = None):
        ...
        frame_number, held_objects_count, visited_rooms_count, successful_objects_count, holding_container = self._calculate_cache_metrics(current_step, holding_objects, rooms_explored, satisfied)
    ...
    def _calculate_cache_metrics(self, current_step, holding_objects, rooms_explored, satisfied):
        ...
        return frame_number, held_objects_count, visited_rooms_count, successful_objects_count, holding_container
    ...
    def _load_action_2gram_data(self):
        ...
        if file_path is None:
            self._debug_print("Warning: action_2gram_grouped_by_start.txt (or _v2.txt or _v3.txt) not found")
            self.action_transitions = {}
            return
        
        self.action_transitions = {}
        
        # Detect file format (v2 and v3 use same format, v3 just has additional std field)
        is_v2_or_v3_format = '_v2.txt' in file_path or '_v3.txt' in file_path
        ...
        try:
            ...
            format_version = 'v2/v3' if is_v2_or_v3_format else 'v1'
    ...
    def get_possible_actions_by_last_action(self, last_action, rooms_count, held_count, container_count, satisfied_count, steps_count):
        """
    ...
    def get_possible_actions_by_last_action_with_gaussian_decay(self, last_action, rooms_count, held_count, container_count, satisfied_count, steps_count):
        """
    ...
    def get_action_cache_lookup(self, last_action, current_step, current_room, rooms_explored, holding_objects, satisfied):
        ...
        frame_number, held_objects_count, visited_rooms_count, successful_objects_count, holding_container = self._calculate_cache_metrics(
    ...
    def _update_transition_metrics(self, transition, metrics):
        ...
        for metric_name in ['rooms', 'held', 'container', 'satisfied', 'steps']:
    ...
    def get_possible_actions_by_last_action_with_gaussian_decay_no_norm(self, last_action, rooms_count, held_count, container_count, satisfied_count, steps_count):
        """
